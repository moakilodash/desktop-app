...
export class WebSocketService {
  ...
  constructor(storeOrUrl?: Store<RootState> | string) {
    if (typeof storeOrUrl === 'string') {
      // A URL was provided as a string
      this.currentUrl = storeOrUrl
    } else if (storeOrUrl) {
      // A store has been provided
      this.initializeStoreSubscription(storeOrUrl)
    } else {
      // Neither a store nor a URL was provided
      console.warn(
        'Neither store nor URL provided to WebSocketService. Using fallback URL.'
      )
  ...
  private initializeStoreSubscription(store: Store<RootState>) {
