...
export const Toolbar = () => {
  ...
  return (
    <aside className="fixed h-full w-64 bg-gray-900 shadow-lg flex flex-col justify-between py-6 px-4">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg text-center max-w-md w-full">
            ...
            <div className="flex space-x-4">
              <button
                className="flex-1 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white text-lg font-bold rounded shadow-md transition duration-200"
                disabled={isLoading}
              ...
              <button
                className="flex-1 px-6 py-3 bg-cyan-400 hover:bg-cyan-300 text-gray-900 text-lg font-bold rounded shadow-md transition duration-200"
                disabled={isLoading}
                onClick={() =>
