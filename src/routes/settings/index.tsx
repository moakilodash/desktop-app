...
import { setBitcoinUnit, setNodeConnectionString, setDefaultLspUrl } from '../../slices/settings/settings.slice';
...
export const Component = () => {
  ...
  const { bitcoinUnit, nodeConnectionString, defaultLspUrl } = useSelector(state => state.settings);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 to-black">
      <div className="max-w-md w-full bg-blue-dark p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-semibold mb-8 text-center text-white">Settings</h1>
        <form onSubmit={form.handleSubmit(handleSave)}>
          <div className="space-y-6">
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <label className="block mb-2 text-lg text-gray-300">Select Bitcoin Unit:</label>
                  <select
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <label className="block mb-2 text-lg text-gray-300">Node Connection String:</label>
                  <input
                    type="text"
                    className="w-full p-3 bg-gray-700 text-white rounded border border-gray-600 focus:border-cyan-500 focus:ring-cyan-500 focus:outline-none"
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <label className="block mb-2 text-lg text-gray-300">Default LSP URL:</label>
                  <input
                    type="text"
                    className="w-full p-3 bg-gray-700 text-white rounded border border-gray-600 focus:border-cyan-500 focus:ring-cyan-500 focus:outline-none"
