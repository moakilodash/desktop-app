...
import { channelSliceSelectors } from '../../slices/channel/channel.slice'
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-gray-800 text-white rounded-lg shadow-md">
      <div className="text-center mb-10">
        <h3 className="text-3xl font-semibold mb-4">Confirm Channel - Step 3</h3>
        <p className="text-lg text-gray-400">Last confirmation before the channel is opened.</p>
      </div>
      ...
      {props.error && (
        <div className="flex justify-end text-red-500 mt-4">
          {props.error}
        </div>
      )}
    </div>
